...
public class GameController : MonoBehaviour 
{
	...
	void Update ()
	{
		...
		if (toBeInstatiated != null && currentBase != null && currentBase.getMoney () > toBeInstatiated.GetComponent<Fighter> ().price && isRunning)
		{
			Vector3 position;
			Quaternion rotation;
			...
			fighterScript.baseOwner = currentBase;
			currentBase.increaseIncome (fighterScript.incomeIncrement);
			currentBase.decreaseMoney (fighterScript.price);
